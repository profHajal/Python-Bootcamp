...
def checker(buttons):
    ...
    if buttons["text"] == ' ' and click == True:
        ...
        click = True
          ...
          tkinter.messagebox.showinfo("Winner X","Your Are won the game")
          ...
          tkinter.messagebox.showinfo("Winner 0","Your Are won the game")
    else:
        tkinter.messagebox.showinfo("Draw","It's Draw")
